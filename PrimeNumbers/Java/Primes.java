/*
Kevin Nguyen
A small naive program to output primes up to a specific value. Performance is atleast O(M*N) where M is a constant from 1-10 and N is the size of the input.
